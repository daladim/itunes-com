...
pub unsafe trait IITObject : IDispatch {
    ...
    unsafe fn GetITObjectIDs(&self, sourceID: *mut LONG, playlistID: *mut LONG, trackID: *mut LONG, databaseID: *mut LONG) -> HRESULT;
    ...
    unsafe fn Index(&self, Index: *mut LONG) -> HRESULT;
    /// The source ID of the object.
    unsafe fn sourceID(&self, sourceID: *mut LONG) -> HRESULT;
    /// The playlist ID of the object.
    unsafe fn playlistID(&self, playlistID: *mut LONG) -> HRESULT;
    /// The track ID of the object.
    unsafe fn trackID(&self, trackID: *mut LONG) -> HRESULT;
    /// The track database ID of the object.
    unsafe fn TrackDatabaseID(&self, databaseID: *mut LONG) -> HRESULT;
}
...
pub unsafe trait IITSource : IITObject {
    ...
    unsafe fn Capacity(&self, Capacity: *mut DOUBLE) -> HRESULT;
    /// The free space on the source, if it has a fixed size.
    unsafe fn FreeSpace(&self, FreeSpace: *mut DOUBLE) -> HRESULT;
...
pub unsafe trait IITPlaylistCollection : IDispatch {
    ...
    unsafe fn Count(&self, Count: *mut LONG) -> HRESULT;
    /// Returns an IITPlaylist object corresponding to the given index (1-based).
    unsafe fn Item(&self, Index: LONG, iPlaylist: *mut Option<IITPlaylist>) -> HRESULT;
    /// Returns an IITPlaylist object with the specified name.
    unsafe fn ItemByName(&self, Name: BSTR, iPlaylist: *mut Option<IITPlaylist>) -> HRESULT;
    ...
    unsafe fn ItemByPersistentID(&self, highID: LONG, lowID: LONG, iPlaylist: *mut Option<IITPlaylist>) -> HRESULT;
}
...
pub unsafe trait IITPlaylist : IITObject {
    ...
    unsafe fn PlayFirstTrack(&self) -> HRESULT;
    /// Print this playlist.
    unsafe fn Print(&self, showPrintDialog: VARIANT_BOOL, printKind: ITPlaylistPrintKind, theme: BSTR) -> HRESULT;
    /// Search tracks in this playlist for the specified string.
    unsafe fn Search(&self, searchText: BSTR, searchFields: ITPlaylistSearchField, iTrackCollection: *mut Option<IITTrackCollection>) -> HRESULT;
    /// The playlist kind.
    unsafe fn Kind(&self, Kind: *mut ITPlaylistKind) -> HRESULT;
    /// The source that contains this playlist.
    unsafe fn Source(&self, iSource: *mut Option<IITSource>) -> HRESULT;
    /// The total length of all songs in the playlist (in seconds).
    unsafe fn Duration(&self, Duration: *mut LONG) -> HRESULT;
    /// True if songs in the playlist are played in random order.
    unsafe fn Shuffle(&self, isShuffle: *mut VARIANT_BOOL) -> HRESULT;
    /// True if songs in the playlist are played in random order.
    unsafe fn set_Shuffle(&self, isShuffle: VARIANT_BOOL) -> HRESULT;
    /// The total size of all songs in the playlist (in bytes).
    unsafe fn Size(&self, Size: *mut DOUBLE) -> HRESULT;
    /// The playback repeat mode.
    unsafe fn SongRepeat(&self, repeatMode: *mut ITPlaylistRepeatMode) -> HRESULT;
    /// The playback repeat mode.
    unsafe fn set_SongRepeat(&self, repeatMode: ITPlaylistRepeatMode) -> HRESULT;
...
pub unsafe trait IITTrackCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iTrack: *mut Option<IITTrack>) -> HRESULT;
    ...
    unsafe fn ItemByPlayOrder(&self, Index: LONG, iTrack: *mut Option<IITTrack>) -> HRESULT;
    ...
    unsafe fn ItemByPersistentID(&self, highID: LONG, lowID: LONG, iTrack: *mut Option<IITTrack>) -> HRESULT;
}
...
pub unsafe trait IITTrack : IITObject {
    ...
    unsafe fn BitRate(&self, BitRate: *mut LONG) -> HRESULT;
    /// The tempo of the track (in beats per minute).
    unsafe fn BPM(&self, beatsPerMinute: *mut LONG) -> HRESULT;
    /// The tempo of the track (in beats per minute).
    unsafe fn set_BPM(&self, beatsPerMinute: LONG) -> HRESULT;
    ...
    unsafe fn DateAdded(&self, DateAdded: *mut DATE) -> HRESULT;
    /// The total number of discs in the source album.
    unsafe fn DiscCount(&self, DiscCount: *mut LONG) -> HRESULT;
    /// The total number of discs in the source album.
    unsafe fn set_DiscCount(&self, DiscCount: LONG) -> HRESULT;
    /// The index of the disc containing the track on the source album.
    unsafe fn DiscNumber(&self, DiscNumber: *mut LONG) -> HRESULT;
    /// The index of the disc containing the track on the source album.
    unsafe fn set_DiscNumber(&self, DiscNumber: LONG) -> HRESULT;
    ...
    unsafe fn set_Finish(&self, Finish: LONG) -> HRESULT;
    /// The stop time of the track (in seconds).
    unsafe fn Finish(&self, Finish: *mut LONG) -> HRESULT;
    ...
    unsafe fn ModificationDate(&self, dateModified: *mut DATE) -> HRESULT;
    /// The number of times the track has been played.
    unsafe fn PlayedCount(&self, PlayedCount: *mut LONG) -> HRESULT;
    /// The number of times the track has been played.
    unsafe fn set_PlayedCount(&self, PlayedCount: LONG) -> HRESULT;
    /// The date and time the track was last played.  A value of zero means no played date.
    unsafe fn PlayedDate(&self, PlayedDate: *mut DATE) -> HRESULT;
    /// The date and time the track was last played.  A value of zero means no played date.
    unsafe fn set_PlayedDate(&self, PlayedDate: DATE) -> HRESULT;
    /// The play order index of the track in the owner playlist (1-based).
    unsafe fn PlayOrderIndex(&self, Index: *mut LONG) -> HRESULT;
    /// The rating of the track (0 to 100).
    unsafe fn Rating(&self, Rating: *mut LONG) -> HRESULT;
    /// The rating of the track (0 to 100).
    unsafe fn set_Rating(&self, Rating: LONG) -> HRESULT;
    /// The sample rate of the track (in Hz).
    unsafe fn SampleRate(&self, SampleRate: *mut LONG) -> HRESULT;
    /// The size of the track (in bytes).
    unsafe fn Size(&self, Size: *mut LONG) -> HRESULT;
    /// The start time of the track (in seconds).
    unsafe fn Start(&self, Start: *mut LONG) -> HRESULT;
    /// The start time of the track (in seconds).
    unsafe fn set_Start(&self, Start: LONG) -> HRESULT;
    /// The length of the track (in MM:SS format).
    unsafe fn Time(&self, Time: *mut BSTR) -> HRESULT;
    /// The total number of tracks on the source album.
    unsafe fn TrackCount(&self, TrackCount: *mut LONG) -> HRESULT;
    /// The total number of tracks on the source album.
    unsafe fn set_TrackCount(&self, TrackCount: LONG) -> HRESULT;
    /// The index of the track on the source album.
    unsafe fn TrackNumber(&self, TrackNumber: *mut LONG) -> HRESULT;
    /// The index of the track on the source album.
    unsafe fn set_TrackNumber(&self, TrackNumber: LONG) -> HRESULT;
    /// The relative volume adjustment of the track (-100% to 100%).
    unsafe fn VolumeAdjustment(&self, VolumeAdjustment: *mut LONG) -> HRESULT;
    /// The relative volume adjustment of the track (-100% to 100%).
    unsafe fn set_VolumeAdjustment(&self, VolumeAdjustment: LONG) -> HRESULT;
    /// The year the track was recorded/released.
    unsafe fn Year(&self, Year: *mut LONG) -> HRESULT;
    /// The year the track was recorded/released.
    unsafe fn set_Year(&self, Year: LONG) -> HRESULT;
...
pub unsafe trait IITArtwork : IDispatch {
    ...
    unsafe fn SetArtworkFromFile(&self, filePath: BSTR) -> HRESULT;
    /// Save artwork data to an image file.
    unsafe fn SaveArtworkToFile(&self, filePath: BSTR) -> HRESULT;
    /// The format of the artwork.
    unsafe fn Format(&self, Format: *mut ITArtworkFormat) -> HRESULT;
    /// True if the artwork was downloaded by iTunes.
    unsafe fn IsDownloadedArtwork(&self, IsDownloadedArtwork: *mut VARIANT_BOOL) -> HRESULT;
...
pub unsafe trait IITArtworkCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iArtwork: *mut Option<IITArtwork>) -> HRESULT;
    /// Returns an IEnumVARIANT object which can enumerate the collection.
    ///
    /// Note: I have not figured out how to use it (calling `.Skip(1)` on the returned `IEnumVARIANT` causes a `STATUS_ACCESS_VIOLATION`).<br/>
    /// Feel free to open an issue or a pull request to fix this.
...
pub unsafe trait IITSourceCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iSource: *mut Option<IITSource>) -> HRESULT;
    /// Returns an IITSource object with the specified name.
    unsafe fn ItemByName(&self, Name: BSTR, iSource: *mut Option<IITSource>) -> HRESULT;
    /// Returns an IEnumVARIANT object which can enumerate the collection.
    ///
    /// Note: I have not figured out how to use it (calling `.Skip(1)` on the returned `IEnumVARIANT` causes a `STATUS_ACCESS_VIOLATION`).<br/>
    /// Feel free to open an issue or a pull request to fix this.
    ...
    unsafe fn ItemByPersistentID(&self, highID: LONG, lowID: LONG, iSource: *mut Option<IITSource>) -> HRESULT;
}
...
pub unsafe trait IITEncoderCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iEncoder: *mut Option<IITEncoder>) -> HRESULT;
...
pub unsafe trait IITEQPreset : IDispatch {
    ...
    unsafe fn Modifiable(&self, isModifiable: *mut VARIANT_BOOL) -> HRESULT;
    /// The equalizer preamp level (-12.0 db to +12.0 db).
    unsafe fn Preamp(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer preamp level (-12.0 db to +12.0 db).
    unsafe fn set_Preamp(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 32Hz band level (-12.0 db to +12.0 db).
    unsafe fn Band1(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 32Hz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band1(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 64Hz band level (-12.0 db to +12.0 db).
    unsafe fn Band2(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 64Hz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band2(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 125Hz band level (-12.0 db to +12.0 db).
    unsafe fn Band3(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 125Hz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band3(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 250Hz band level (-12.0 db to +12.0 db).
    unsafe fn Band4(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 250Hz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band4(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 500Hz band level (-12.0 db to +12.0 db).
    unsafe fn Band5(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 500Hz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band5(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 1KHz band level (-12.0 db to +12.0 db).
    unsafe fn Band6(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 1KHz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band6(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 2KHz band level (-12.0 db to +12.0 db).
    unsafe fn Band7(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 2KHz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band7(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 4KHz band level (-12.0 db to +12.0 db).
    unsafe fn Band8(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 4KHz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band8(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 8KHz band level (-12.0 db to +12.0 db).
    unsafe fn Band9(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 8KHz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band9(&self, level: DOUBLE) -> HRESULT;
    /// The equalizer 16KHz band level (-12.0 db to +12.0 db).
    unsafe fn Band10(&self, level: *mut DOUBLE) -> HRESULT;
    /// The equalizer 16KHz band level (-12.0 db to +12.0 db).
    unsafe fn set_Band10(&self, level: DOUBLE) -> HRESULT;
    /// Delete this EQ preset.
    unsafe fn Delete(&self, updateAllTracks: VARIANT_BOOL) -> HRESULT;
    /// Rename this EQ preset.
    unsafe fn Rename(&self, newName: BSTR, updateAllTracks: VARIANT_BOOL) -> HRESULT;
}
...
pub unsafe trait IITEQPresetCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iEQPreset: *mut Option<IITEQPreset>) -> HRESULT;
...
pub unsafe trait IITConvertOperationStatus : IITOperationStatus {
    ...
    unsafe fn GetConversionStatus(&self, trackName: *mut BSTR, progressValue: *mut LONG, maxProgressValue: *mut LONG) -> HRESULT;
    ...
    unsafe fn progressValue(&self, progressValue: *mut LONG) -> HRESULT;
    /// Returns the maximum progress value for the track being converted.
    unsafe fn maxProgressValue(&self, maxProgressValue: *mut LONG) -> HRESULT;
}
...
pub unsafe trait IITURLTrack : IITTrack {
    ...
    unsafe fn AlbumRating(&self, Rating: *mut LONG) -> HRESULT;
    /// The user or computed rating of the album that this track belongs to (0 to 100).
    unsafe fn set_AlbumRating(&self, Rating: LONG) -> HRESULT;
...
pub unsafe trait IITVisualCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iVisual: *mut Option<IITVisual>) -> HRESULT;
...
pub unsafe trait IITWindow : IDispatch {
    ...
    unsafe fn Top(&self, Top: *mut LONG) -> HRESULT;
    /// The screen coordinate of the top edge of the window.
    unsafe fn set_Top(&self, Top: LONG) -> HRESULT;
    /// The screen coordinate of the left edge of the window.
    unsafe fn Left(&self, Left: *mut LONG) -> HRESULT;
    /// The screen coordinate of the left edge of the window.
    unsafe fn set_Left(&self, Left: LONG) -> HRESULT;
    /// The screen coordinate of the bottom edge of the window.
    unsafe fn Bottom(&self, Bottom: *mut LONG) -> HRESULT;
    /// The screen coordinate of the bottom edge of the window.
    unsafe fn set_Bottom(&self, Bottom: LONG) -> HRESULT;
    /// The screen coordinate of the right edge of the window.
    unsafe fn Right(&self, Right: *mut LONG) -> HRESULT;
    /// The screen coordinate of the right edge of the window.
    unsafe fn set_Right(&self, Right: LONG) -> HRESULT;
    /// The width of the window.
    unsafe fn Width(&self, Width: *mut LONG) -> HRESULT;
    /// The width of the window.
    unsafe fn set_Width(&self, Width: LONG) -> HRESULT;
    /// The height of the window.
    unsafe fn Height(&self, Height: *mut LONG) -> HRESULT;
    /// The height of the window.
    unsafe fn set_Height(&self, Height: LONG) -> HRESULT;
}
...
pub unsafe trait IITWindowCollection : IDispatch {
    ...
    unsafe fn Item(&self, Index: LONG, iWindow: *mut Option<IITWindow>) -> HRESULT;
...
pub unsafe trait IiTunes : IDispatch {
    ...
    unsafe fn BackTrack(&self) -> HRESULT;
    /// Skip forward in a playing track.
    unsafe fn FastForward(&self) -> HRESULT;
    /// Advance to the next track in the current playlist.
    unsafe fn NextTrack(&self) -> HRESULT;
    /// Pause playback.
    ...
    unsafe fn ConvertFile(&self, filePath: BSTR, iStatus: *mut Option<IITOperationStatus>) -> HRESULT;
    ...
    unsafe fn ConvertFiles(&self, filePaths: *const VARIANT, iStatus: *mut Option<IITOperationStatus>) -> HRESULT;
    /// Start converting the specified track.  iTrackToConvert is a VARIANT of type VT_DISPATCH that points to an IITTrack.
    unsafe fn ConvertTrack(&self, iTrackToConvert: *const VARIANT, iStatus: *mut Option<IITOperationStatus>) -> HRESULT;
    ...
    unsafe fn ConvertTracks(&self, iTracksToConvert: *const VARIANT, iStatus: *mut Option<IITOperationStatus>) -> HRESULT;
    /// Returns true if this version of the iTunes type library is compatible with the specified version.
    unsafe fn CheckVersion(&self, majorVersion: LONG, minorVersion: LONG, isCompatible: *mut VARIANT_BOOL) -> HRESULT;
    /// Returns an IITObject corresponding to the specified IDs.
    unsafe fn GetITObjectByID(&self, sourceID: LONG, playlistID: LONG, trackID: LONG, databaseID: LONG, iObject: *mut Option<IITObject>) -> HRESULT;
    ...
    unsafe fn Authorize(&self, numElems: LONG, data: *const VARIANT, names: *const BSTR) -> HRESULT;
    /// Exits the iTunes application.
    unsafe fn Quit(&self) -> HRESULT;
    /// Returns a collection of music sources (music library, CD, device, etc.).
    unsafe fn Sources(&self, iSourceCollection: *mut Option<IITSourceCollection>) -> HRESULT;
    /// Returns a collection of encoders.
    unsafe fn Encoders(&self, iEncoderCollection: *mut Option<IITEncoderCollection>) -> HRESULT;
    /// Returns a collection of EQ presets.
    unsafe fn EQPresets(&self, iEQPresetCollection: *mut Option<IITEQPresetCollection>) -> HRESULT;
    /// Returns a collection of visual plug-ins.
    unsafe fn Visuals(&self, iVisualCollection: *mut Option<IITVisualCollection>) -> HRESULT;
    /// Returns a collection of windows.
    unsafe fn Windows(&self, iWindowCollection: *mut Option<IITWindowCollection>) -> HRESULT;
    /// Returns the sound output volume (0 = minimum, 100 = maximum).
    unsafe fn SoundVolume(&self, volume: *mut LONG) -> HRESULT;
    /// Returns the sound output volume (0 = minimum, 100 = maximum).
    unsafe fn set_SoundVolume(&self, volume: LONG) -> HRESULT;
    /// True if sound output is muted.
    unsafe fn Mute(&self, isMuted: *mut VARIANT_BOOL) -> HRESULT;
    /// True if sound output is muted.
    unsafe fn set_Mute(&self, isMuted: VARIANT_BOOL) -> HRESULT;
    /// Returns the current player state.
    unsafe fn PlayerState(&self, PlayerState: *mut ITPlayerState) -> HRESULT;
    /// Returns the player's position within the currently playing track in seconds.
    unsafe fn PlayerPosition(&self, playerPos: *mut LONG) -> HRESULT;
    /// Returns the player's position within the currently playing track in seconds.
    unsafe fn set_PlayerPosition(&self, playerPos: LONG) -> HRESULT;
    /// Returns the currently selected encoder (AAC, MP3, AIFF, WAV, etc.).
    unsafe fn CurrentEncoder(&self, iEncoder: *mut Option<IITEncoder>) -> HRESULT;
    /// Returns the currently selected encoder (AAC, MP3, AIFF, WAV, etc.).
    unsafe fn set_CurrentEncoder(&self, iEncoder: *const IITEncoder) -> HRESULT;
    /// True if visuals are currently being displayed.
    unsafe fn VisualsEnabled(&self, isEnabled: *mut VARIANT_BOOL) -> HRESULT;
    /// True if visuals are currently being displayed.
    unsafe fn set_VisualsEnabled(&self, isEnabled: VARIANT_BOOL) -> HRESULT;
    /// True if the visuals are displayed using the entire screen.
    unsafe fn FullScreenVisuals(&self, isFullScreen: *mut VARIANT_BOOL) -> HRESULT;
    /// True if the visuals are displayed using the entire screen.
    unsafe fn set_FullScreenVisuals(&self, isFullScreen: VARIANT_BOOL) -> HRESULT;
    /// Returns the size of the displayed visual.
    unsafe fn VisualSize(&self, VisualSize: *mut ITVisualSize) -> HRESULT;
    /// Returns the size of the displayed visual.
    unsafe fn set_VisualSize(&self, VisualSize: ITVisualSize) -> HRESULT;
    /// Returns the currently selected visual plug-in.
    unsafe fn CurrentVisual(&self, iVisual: *mut Option<IITVisual>) -> HRESULT;
    /// Returns the currently selected visual plug-in.
    unsafe fn set_CurrentVisual(&self, iVisual: *const IITVisual) -> HRESULT;
    /// True if the equalizer is enabled.
    unsafe fn EQEnabled(&self, isEnabled: *mut VARIANT_BOOL) -> HRESULT;
    /// True if the equalizer is enabled.
    unsafe fn set_EQEnabled(&self, isEnabled: VARIANT_BOOL) -> HRESULT;
    /// Returns the currently selected EQ preset.
    unsafe fn CurrentEQPreset(&self, iEQPreset: *mut Option<IITEQPreset>) -> HRESULT;
    /// Returns the currently selected EQ preset.
    unsafe fn set_CurrentEQPreset(&self, iEQPreset: *const IITEQPreset) -> HRESULT;
    /// The name of the current song in the playing stream (provided by streaming server).
    unsafe fn CurrentStreamTitle(&self, streamTitle: *mut BSTR) -> HRESULT;
    /// The URL of the playing stream or streaming web site (provided by streaming server).
    unsafe fn set_CurrentStreamURL(&self, streamURL: *mut BSTR) -> HRESULT;
    /// Returns the main iTunes browser window.
    unsafe fn BrowserWindow(&self, iBrowserWindow: *mut Option<IITBrowserWindow>) -> HRESULT;
    /// Returns the EQ window.
    unsafe fn EQWindow(&self, iEQWindow: *mut Option<IITWindow>) -> HRESULT;
    /// Returns the source that represents the main library.
    unsafe fn LibrarySource(&self, iLibrarySource: *mut Option<IITSource>) -> HRESULT;
    /// Returns the main library playlist in the main library source.
    unsafe fn LibraryPlaylist(&self, iLibraryPlaylist: *mut Option<IITLibraryPlaylist>) -> HRESULT;
    /// Returns the currently targeted track.
    unsafe fn CurrentTrack(&self, iTrack: *mut Option<IITTrack>) -> HRESULT;
    /// Returns the playlist containing the currently targeted track.
    unsafe fn CurrentPlaylist(&self, iPlaylist: *mut Option<IITPlaylist>) -> HRESULT;
    /// Returns a collection containing the currently selected track or tracks.
    unsafe fn SelectedTracks(&self, iTrackCollection: *mut Option<IITTrackCollection>) -> HRESULT;
    /// Returns the version of the iTunes application.
    unsafe fn Version(&self, Version: *mut BSTR) -> HRESULT;
    /// [id(0x6002003b)]
    /// (no other documentation provided)
    unsafe fn SetOptions(&self, options: LONG) -> HRESULT;
    /// Start converting the specified file path.
    unsafe fn ConvertFile2(&self, filePath: BSTR, iStatus: *mut Option<IITConvertOperationStatus>) -> HRESULT;
    /// Start converting the specified array of file paths. filePaths can be of type VT_ARRAY|VT_VARIANT, where each entry is a VT_BSTR, or VT_ARRAY|VT_BSTR.  You can also pass a JScript Array object.
    unsafe fn ConvertFiles2(&self, filePaths: *const VARIANT, iStatus: *mut Option<IITConvertOperationStatus>) -> HRESULT;
    /// Start converting the specified track.  iTrackToConvert is a VARIANT of type VT_DISPATCH that points to an IITTrack.
    unsafe fn ConvertTrack2(&self, iTrackToConvert: *const VARIANT, iStatus: *mut Option<IITConvertOperationStatus>) -> HRESULT;
    /// Start converting the specified tracks.  iTracksToConvert is a VARIANT of type VT_DISPATCH that points to an IITTrackCollection.
    unsafe fn ConvertTracks2(&self, iTracksToConvert: *const VARIANT, iStatus: *mut Option<IITConvertOperationStatus>) -> HRESULT;
    /// True if iTunes will process APPCOMMAND Windows messages.
    unsafe fn AppCommandMessageProcessingEnabled(&self, isEnabled: *mut VARIANT_BOOL) -> HRESULT;
    /// True if iTunes will process APPCOMMAND Windows messages.
    unsafe fn set_AppCommandMessageProcessingEnabled(&self, isEnabled: VARIANT_BOOL) -> HRESULT;
    /// True if iTunes will force itself to be the foreground application when it displays a dialog.
    unsafe fn ForceToForegroundOnDialog(&self, ForceToForegroundOnDialog: *mut VARIANT_BOOL) -> HRESULT;
    /// True if iTunes will force itself to be the foreground application when it displays a dialog.
    unsafe fn set_ForceToForegroundOnDialog(&self, ForceToForegroundOnDialog: VARIANT_BOOL) -> HRESULT;
    /// Create a new EQ preset.
    unsafe fn CreateEQPreset(&self, eqPresetName: BSTR, iEQPreset: *mut Option<IITEQPreset>) -> HRESULT;
    /// Creates a new playlist in an existing source.
    unsafe fn CreatePlaylistInSource(&self, playlistName: BSTR, iSource: *const VARIANT, iPlaylist: *mut Option<IITPlaylist>) -> HRESULT;
    /// Retrieves the current state of the player buttons.
    unsafe fn GetPlayerButtonsState(&self, previousEnabled: *mut VARIANT_BOOL, playPauseStopState: *mut ITPlayButtonState, nextEnabled: *mut VARIANT_BOOL) -> HRESULT;
    /// Simulate click on a player control button.
    unsafe fn PlayerButtonClicked(&self, playerButton: ITPlayerButton, playerButtonModifierKeys: LONG) -> HRESULT;
    /// True if the Shuffle property is writable for the specified playlist.
    unsafe fn CanSetShuffle(&self, iPlaylist: *const VARIANT, CanSetShuffle: *mut VARIANT_BOOL) -> HRESULT;
    /// True if the SongRepeat property is writable for the specified playlist.
    unsafe fn CanSetSongRepeat(&self, iPlaylist: *const VARIANT, CanSetSongRepeat: *mut VARIANT_BOOL) -> HRESULT;
    /// Returns an IITConvertOperationStatus object if there is currently a conversion in progress.
    unsafe fn ConvertOperationStatus(&self, iStatus: *mut Option<IITConvertOperationStatus>) -> HRESULT;
    /// Subscribe to the specified podcast feed URL.
    unsafe fn SubscribeToPodcast(&self, URL: BSTR) -> HRESULT;
    /// Update all podcast feeds.
    unsafe fn UpdatePodcastFeeds(&self) -> HRESULT;
    /// Creates a new folder in the main library.
    unsafe fn CreateFolder(&self, folderName: BSTR, iFolder: *mut Option<IITPlaylist>) -> HRESULT;
    /// Creates a new folder in an existing source.
    unsafe fn CreateFolderInSource(&self, folderName: BSTR, iSource: *const VARIANT, iFolder: *mut Option<IITPlaylist>) -> HRESULT;
    /// True if the sound volume control is enabled.
    unsafe fn SoundVolumeControlEnabled(&self, isEnabled: *mut VARIANT_BOOL) -> HRESULT;
    /// The full path to the current iTunes library XML file.
    unsafe fn LibraryXMLPath(&self, filePath: *mut BSTR) -> HRESULT;
    /// Returns the high 32 bits of the persistent ID of the specified IITObject.
    unsafe fn ITObjectPersistentIDHigh(&self, iObject: *const VARIANT, highID: *mut LONG) -> HRESULT;
    /// Returns the low 32 bits of the persistent ID of the specified IITObject.
    unsafe fn ITObjectPersistentIDLow(&self, iObject: *const VARIANT, lowID: *mut LONG) -> HRESULT;
    /// Returns the high and low 32 bits of the persistent ID of the specified IITObject.
    unsafe fn GetITObjectPersistentIDs(&self, iObject: *const VARIANT, highID: *mut LONG, lowID: *mut LONG) -> HRESULT;
    /// Returns the player's position within the currently playing track in milliseconds.
    unsafe fn PlayerPositionMS(&self, playerPos: *mut LONG) -> HRESULT;
    /// Returns the player's position within the currently playing track in milliseconds.
    unsafe fn set_PlayerPositionMS(&self, playerPos: LONG) -> HRESULT;
}
...
pub unsafe trait IITFileOrCDTrack : IITTrack {
    ...
    unsafe fn BookmarkTime(&self, BookmarkTime: *mut LONG) -> HRESULT;
    /// The bookmark time of the track (in seconds).
    unsafe fn set_BookmarkTime(&self, BookmarkTime: LONG) -> HRESULT;
    ...
    unsafe fn SkippedCount(&self, SkippedCount: *mut LONG) -> HRESULT;
    /// The number of times the track has been skipped.
    unsafe fn set_SkippedCount(&self, SkippedCount: LONG) -> HRESULT;
    /// The date and time the track was last skipped.  A value of zero means no skipped date.
    unsafe fn SkippedDate(&self, SkippedDate: *mut DATE) -> HRESULT;
    /// The date and time the track was last skipped.  A value of zero means no skipped date.
    unsafe fn set_SkippedDate(&self, SkippedDate: DATE) -> HRESULT;
    ...
    unsafe fn SeasonNumber(&self, SeasonNumber: *mut LONG) -> HRESULT;
    /// The season number of the track.
    unsafe fn set_SeasonNumber(&self, SeasonNumber: LONG) -> HRESULT;
    ...
    unsafe fn EpisodeNumber(&self, EpisodeNumber: *mut LONG) -> HRESULT;
    /// The episode number of the track.
    unsafe fn set_EpisodeNumber(&self, EpisodeNumber: LONG) -> HRESULT;
    /// The high 32-bits of the size of the track (in bytes).
    unsafe fn Size64High(&self, sizeHigh: *mut LONG) -> HRESULT;
    /// The low 32-bits of the size of the track (in bytes).
    unsafe fn Size64Low(&self, sizeLow: *mut LONG) -> HRESULT;
    ...
    unsafe fn ReleaseDate(&self, ReleaseDate: *mut DATE) -> HRESULT;
}
